#Multinomial logistic model selection analysis - for cluster
...
MNLOG <- postpr(target = rscobs, index = mod, sumstat = ss, tol = tol, method = "mnlogistic")
save(MNLOG, file = paste0("rsc_modsel_100ksubset_MNLOG-",tol,".rda"))
